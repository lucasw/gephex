...
TypeViewFactory::TypeViewFactory(const std::string &media_path) {
  ...
  registerTypeViewConstructor("typ_StringType", new StringViewConstructor());
  ...
  registerTypeViewConstructor("typ_RGBType", new ColorViewConstructor());

  registerTypeViewConstructor("typ_FontType", new FontViewConstructor());
...
void TypeViewFactory::registerTypeViewConstructor(const std::string &typeID,
  ...
  m_infoMap[typeID].push_back(TypeViewInfo(con->getName(), con->getViewID()));
...
TypeViewFactory::getConstructor(const std::string &viewID) const {
  ViewToConstructorMap::const_iterator it = m_constructorMap.find(viewID);
