...
static const char *logo_data[] = {"40 40 8 1",
                                  "# c #000200",
                                  "a c #8e908d",
                                  "b c #970d17",
                                  ". c #9ea09d",
...
int main(int argc, const char *argv[]) {
  ...
  try {
    ...
    params.push_back(config_param_t("ipc_inet_hostname",
                                    config_param_t::STRING_PARAM, "gui",
                                    "Hostname of engine (inet only)", 0));

    def.s = ".";
    params.push_back(
        config_param_t("ipc_namedpipe_servername", config_param_t::STRING_PARAM,
                       "gui", "Servername of engine (namedpipe only)", &def));
    ...
    gui::VJMainWindow mainWin(0, config, ipc_locator, get_conf_base_dir());
