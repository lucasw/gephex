...
public:
   ...
   *
   */
  virtual void elementsConnected(int id1, int outIndex, int id2,
                                 int inIndex) = 0;
   ...
   *
   */
  virtual void connectInputInProgress(int elemId, int inIndex, int x,
                                      int y) = 0;

  /**
   *
   */
  virtual void connectOutputInProgress(int elemId, int outIndex, int x,
                                       int y) = 0;
};
