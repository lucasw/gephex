...
class ControlEditor : public QWidget, public IControlView {
  Q_OBJECT
public:
  typedef std::map<std::string, std::string> ParamMap;

  ControlEditor(QWidget *parent, ControlModel &cModel,
  ...
  virtual void controlAdded(int controlID, const std::string &name, int nodeID,
