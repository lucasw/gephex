...
ControlEditorWindow::ControlEditorWindow(
    QWidget *parent, ControlModel &controlModel, IModelControlReceiver &model,
...
ControlEditor *ControlEditorWindow::controlEditor() { return m_controlEditor; }
