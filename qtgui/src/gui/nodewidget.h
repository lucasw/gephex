...
private:
  ...
  std::vector<QPixmap>
      pictures; // pointer to the backgroundpics n stuff the node is using
...
public:
  NodeWidget(QWidget *parent, Qt::WFlags fl, int id, const ModuleInfo &_info,
...
public slots:
  ...
  void connectionRequestFromOutput_(const OutputPlugWidget *, const QPoint &to);
