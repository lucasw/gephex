...
public:
  KeyTranslator() {
    ...
    m_modifiers["ctrlaltshift"] =
        Key::CtrlModifier | Key::AltModifier | Key::ShiftModifier;
    ...
    m_codes["f1"] = Key::Key_F1;
    m_codes["f2"] = Key::Key_F2;
    m_codes["f3"] = Key::Key_F3;
    m_codes["f4"] = Key::Key_F4;
    m_codes["f5"] = Key::Key_F5;
    m_codes["f6"] = Key::Key_F6;
    m_codes["f7"] = Key::Key_F7;
    m_codes["f8"] = Key::Key_F8;
    m_codes["f9"] = Key::Key_F9;
    m_codes["f10"] = Key::Key_F10;
    m_codes["f11"] = Key::Key_F11;
    m_codes["f12"] = Key::Key_F12;
  ...
  bool translate(const std::string &keyID, int &code, int &modifierMask) {
    ...
    if (pos == std::string::npos) {
      ...
      std::map<std::string, int>::const_iterator it = m_modifiers.find(mod);
    ...
    std::map<std::string, int>::const_iterator it = m_codes.find(keyName);
...
static bool translateKeyID(const std::string &keyID, int &code,
                           int &modifierMask) {
...
int Key::code() const { return m_code; }

int Key::modifierMask() const { return m_modifierMask; }

bool Key::operator==(const Key &rhs) const {
  return (code() == rhs.code() && modifierMask() == rhs.modifierMask());
}
