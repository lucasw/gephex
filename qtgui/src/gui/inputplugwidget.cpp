...
InputPlugWidget::InputPlugWidget(QWidget *parent, const QPixmap &free_,
...
void InputPlugWidget::mouseReleaseEvent(QMouseEvent *e) {
  if (m_lineDrawMode) {
    ...
    emit connectionRequestFromInput(this, e->pos() + this->pos() +
                                              parentWidget()->pos());
  }
}
...
bool InputPlugWidget::isVisible() const { return !inPropertyDialog; }
