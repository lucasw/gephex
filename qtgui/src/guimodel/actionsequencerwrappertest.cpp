		  ...
		  const std::string& fehlerText, bool verbose = false)
{
  ...
  out.flush();
  if (out.str() != soll)
    throw std::runtime_error(fehlerText.c_str() + out.str());
}  
...
void test1()
{
  ...
  testListener(listener,
	       "[id=1; content=<changeGraph:hallo>; length=4; ]",
	       "1.1");
  ...
  testListener(listener,"[id=2; content=<changeGraph:ciao>; length=3; ]",
	       "1.3");

  sequencer.appendScene("dumm",5);
  testListener(listener,
	       "[id=2; content=<changeGraph:ciao>; length=3; id=3; "
	       "content=<changeGraph:dumm>; length=5; ]","1.4");
...
void test2()
{
  ...
  sequencer.appendScene("hallo",4);
  testListener(listener,"[id=1; content=<changeGraph:hallo>; length=4; ]","2.1");
	
  sequencer.appendScene("ciao",3);
  testListener(listener,"[id=1; content=<changeGraph:hallo>; length=4; id=2; content=<changeGraph:ciao>; length=3; ]","2.2");
		
  sequencer.appendScene("dumm",5);
  testListener(listener,"[id=1; content=<changeGraph:hallo>; length=4; id=2; content=<changeGraph:ciao>; length=3; id=3; content=<changeGraph:dumm>; length=5; ]","2.3");
	
  sequencer.deleteScene(2);
  testListener(listener,"[id=1; content=<changeGraph:hallo>; length=4; id=3; content=<changeGraph:dumm>; length=5; ]","2.4");	
}
...
void test3()
{
  ...
  testListener(listener,"[id=1; content=<changeGraph:base>; length=3; ]","3.1",
	       false);

  sequencer.appendScene("temp",5);
  testListener(listener,"[id=1; content=<changeGraph:base>; length=3; id=2; content=<changeGraph:temp>; length=5; ]","3.2",false);

  sequencer.deleteScene(2);
  testListener(listener,"[id=1; content=<changeGraph:base>; length=3; ]","3.3",false);

  sequencer.appendScene("neu",1);
  testListener(listener,"[id=1; content=<changeGraph:base>; length=3; id=3; content=<changeGraph:neu>; length=1; ]","3.4",false);	
}
