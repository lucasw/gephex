...
ModuleInfo::ModuleInfo(const std::string &_identifier, const std::string &_name,
                       const std::string &group_,
                       const std::vector<PlugInfo> &_inputs,
                       const std::vector<PlugInfo> &_outputs,
                       utils::AutoPtr<Xpm> &_pixmap)
    : identifier(_identifier), name(_name), group(group_), inputs(_inputs),
      outputs(_outputs), pixmap(_pixmap) {}
