...
void DummyModelControlSender::registerModelControlReceiver(
    IModelControlReceiver &_mcr) {
  mcr = &_mcr;
}

class DummyModuleConstructionSmartReceiver
...
void DummyModuleConstructionSmartReceiver::moduleAdded(int graphID,
                                                       int moduleClassID,
                                                       int modID) {
  std::cout << "graphID: " << graphID << " moduleClassID: " << moduleClassID
            << " modID: " << modID << std::endl;
}

void DummyModuleConstructionSmartReceiver::modulesConnected(int graphID,
                                                            int moduleID1,
                                                            int outputIndex,
                                                            int moduleID2,
                                                            int inputIndex) {
  std::cout << "graphID: " << graphID << " moduleID1: " << moduleID1
            << " outputIndex: " << outputIndex << " moduleID2: " << moduleID2
            << " inputIndex: " << inputIndex << std::endl;
}

void DummyModuleConstructionSmartReceiver::modulesDisconnected(int graphID,
                                                               int moduleID,
                                                               int inputIndex) {
  std::cout << " graphID: " << graphID << " moduleID: " << moduleID
            << " inputIndex: " << inputIndex << std::endl;
}

void DummyModuleConstructionSmartReceiver::moduleDeleted(int graphID,
                                                         int moduleID) {
  std::cout << " graphID: " << graphID << " moduleID: " << moduleID
            << std::endl;
}
...
class DummyModuleConstructionDumbReceiver
...
public:
  ...
  virtual void modulesConnected(int moduleID1, int outputIndex, int moduleID2,
                                int inputIndex);
...
void DummyModuleConstructionDumbReceiver::moduleAdded(int moduleClassID,
                                                      int modID) {
  std::cout << "moduleClassID: " << moduleClassID << " modID: " << modID
            << std::endl;
}

void DummyModuleConstructionDumbReceiver::modulesConnected(int moduleID1,
                                                           int outputIndex,
                                                           int moduleID2,
                                                           int inputIndex) {
  std::cout << "moduleID1: " << moduleID1 << " outputIndex: " << outputIndex
            << " moduleID2: " << moduleID2 << " inputIndex: " << inputIndex
            << std::endl;
}

void DummyModuleConstructionDumbReceiver::modulesDisconnected(int moduleID,
                                                              int inputIndex) {
  std::cout << "moduleID: " << moduleID << " inputIndex: " << inputIndex
            << std::endl;
}
...
void DummyModuleConstructionDumbReceiver::graphChanged(
...
void DummyModuleClassSpecSender::registerModuleClassSpecReceiver(
    IModuleClassSpecReceiver &_mcsp) {
  mcsp = &_mcsp;
}
...
void ModelTest::run() {
  ...
  IModuleConstructionSmartReceiver *dmcsr =
      new DummyModuleConstructionSmartReceiver();
  IModuleConstructionDumbReceiver *dmcdr =
      new DummyModuleConstructionDumbReceiver();
  ...
  std::cout << "connecting modules: soll: modID1: 0, outputIndex: 1, modID2: "
               "1, inputIndex: 2\n";
