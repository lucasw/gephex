...
frei0r_module_plugin::frei0r_module_plugin(utils::SharedLibrary &sl,
  ...
  ft.get_plugin_info =
      (f0r_get_plugin_info_t)sl.loadSymbol("f0r_get_plugin_info");
  ft.get_param_info = (f0r_get_param_info_t)sl.loadSymbol("f0r_get_param_info");
  ft.construct = (f0r_construct_t)sl.loadSymbol("f0r_construct");
  ft.destruct = (f0r_destruct_t)sl.loadSymbol("f0r_destruct");
  ft.set_param_value =
      (f0r_set_param_value_t)sl.loadSymbol("f0r_set_param_value");
  ft.get_param_value =
      (f0r_get_param_value_t)sl.loadSymbol("f0r_get_param_value");
