...
public:
  ...
  ~Signals() {
    std::for_each(oldSignalHandlers.begin(), oldSignalHandlers.end(), SetSig());
  }
...
void my_se_translator(unsigned int u, EXCEPTION_POINTERS *p) {
  ...
  case EXCEPTION_DATATYPE_MISALIGNMENT:
    msg += "The thread tried to read or write data that is misaligned on "
  ...
  case EXCEPTION_FLT_DENORMAL_OPERAND:
    msg += "One of the operands in a floating-point operation is denormal. A "
           "denormal value is one that is too small to represent as a standard "
           "floating-point value. ";
    break;
  case EXCEPTION_FLT_DIVIDE_BY_ZERO:
    msg += "The thread tried to divide a floating-point value by a "
           "floating-point divisor of zero. ";
    break;
  case EXCEPTION_FLT_INEXACT_RESULT:
    msg += "The result of a floating-point operation cannot be represented "
           "exactly as a decimal fraction. ";
    break;
  case EXCEPTION_FLT_INVALID_OPERATION:
    msg += "This exception represents any floating-point exception not "
           "included in this list. ";
    break;
  case EXCEPTION_FLT_OVERFLOW:
    msg += "The exponent of a floating-point operation is greater than the "
           "magnitude allowed by the corresponding type. ";
    break;
  case EXCEPTION_FLT_STACK_CHECK:
    msg += "The stack overflowed or underflowed as the result of a "
           "floating-point operation. ";
    break;
  case EXCEPTION_FLT_UNDERFLOW:
    msg += "The exponent of a floating-point operation is less than the "
           "magnitude allowed by the corresponding type. ";
    break;
  ...
  case EXCEPTION_IN_PAGE_ERROR:
    msg += "The thread tried to access a page that was not present, and the "
  ...
  case EXCEPTION_INT_DIVIDE_BY_ZERO:
    msg += "The thread tried to divide an integer value by an integer divisor "
           "of zero. ";
    break;
  case EXCEPTION_INT_OVERFLOW:
    msg += "The result of an integer operation caused a carry out of the most "
           "significant bit of the result. ";
    break;
  case EXCEPTION_INVALID_DISPOSITION:
    msg += "An exception handler returned an invalid disposition to the "
           "exception dispatcher. Programmers using a high-level language such "
           "as C should never encounter this exception. ";
    break;
  case EXCEPTION_NONCONTINUABLE_EXCEPTION:
    msg += "The thread tried to continue execution after a noncontinuable "
           "exception occurred. ";
    break;
  case EXCEPTION_PRIV_INSTRUCTION:
    msg += "The thread tried to execute an instruction whose operation is not "
           "allowed in the current machine mode. ";
    break;
  case EXCEPTION_SINGLE_STEP:
    msg += "A trace trap or other single-instruction mechanism signaled that "
