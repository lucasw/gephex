...
class Renderer : public IRendererControlReceiver,
...
public:
  ...
  virtual void
  registerModuleStatisticsSmartReceiver(IModuleStatisticsSmartReceiver &r);
  ...
  virtual void moduleAdded(const std::string &graphID,
                           const std::string &moduleClassID, int modID);
  virtual void modulesConnected(const std::string &graphID, int moduleID1,
                                int outputIndex, int moduleID2, int inputIndex);
  virtual void modulesDisconnected(const std::string &graphID, int moduleID,
                                   int inputIndex);
  ...
  virtual void setInputValue(const std::string &graphID, int nodeID,
                             int inputIndex, const utils::Buffer &buf);

  // TODO: war mal const
  virtual void syncInputValue(const std::string &graphID, int nodeID,
                              int inputIndex);
