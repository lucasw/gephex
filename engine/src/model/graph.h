...
public:
  ...
  void addModule(const IModuleClassSpec &, ModuleID moduleID);

  void connectModules(ModuleID moduleID1, int outputIndex, ModuleID moduleID2,
                      int inputIndex);
  ...
  void setControlValue(ControlValueSetID &snapShotID, ModuleID nodeID,
                       int inputIndex, const utils::Buffer &newValue);

  void copyControlValueSet(ControlValueSetID &snapID, ControlValueSetID &newID,
