...
public:
  SPlug() {}
  SPlug(const std::string &node_id, const std::string &plug_id);
...
public:
  SSnapshot() {}
  SSnapshot(const std::string &id, const std::string &name,
...
public:
  SDataItem(){};
  SDataItem(const std::string &key, std::string &value);
...
public:
  SNode(){};
  SNode(const std::string &id, const std::string &type,
...
class SGraph {
public:
  SGraph(const std::string &id, const std::string &name,
         std::list<SDataItem> &dataitems, std::list<SNode> &nodes,
         std::list<SConnection> &connections, std::list<SSnapshot> &snapshots);
