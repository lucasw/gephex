...
ControlValueSet::ControlValueSet(const std::string &id, const std::string &name)
    : m_id(id), m_name(name) {}

std::string ControlValueSet::getID() const { return m_id; }

std::string ControlValueSet::getName() const { return m_name; }

void ControlValueSet::setName(const std::string &name) { m_name = name; }
