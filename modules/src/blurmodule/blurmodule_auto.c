...
const char* getSpec(void) {
 return "mod_spec { name=[mod_blurmodule] number_of_inputs=[2] number_of_outputs=[1] deterministic=[true] }";
}
...
{
  static const char* INFO = "info { name=[Blur] group=[Effects] inputs=[2 Wischkraft{lower_bound=[0] step_size=[1] higher_bound=[400] } Bild ] outputs=[1 Bild ] type=xpm } ";
  char* tmpBuf;
