...
const char* getInputSpec(int index) {
 switch(index) {
   case 0:
    return "input_spec { type=typ_NumberType id=r const=true strong_dependency=true default=0.5 } ";
  break;
  case 1:
    return "input_spec { type=typ_NumberType id=g const=true strong_dependency=true default=0.5 } ";
  break;
  case 2:
    return "input_spec { type=typ_NumberType id=b const=true strong_dependency=true default=0.5 } ";
  break;
 }
 return 0;
}
const char* getOutputSpec(int index) {
 switch(index) {
   case 0:
    return "output_spec { type=typ_RGBType id=color } ";
  break;
 }
 return 0;
}
