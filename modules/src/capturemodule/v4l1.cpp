...
int v4l1_device::fd() { return intern->fd; }

const video_capability &v4l1_device::cap() { return intern->cap; }
...
size_t v4l1_device::min_width() { return intern->cap.minwidth; }

size_t v4l1_device::max_width() { return intern->cap.maxwidth; }

size_t v4l1_device::min_height() { return intern->cap.minheight; }

size_t v4l1_device::max_height() { return intern->cap.maxheight; }
