...
void controlchange_callback(unsigned char channel, unsigned char control,
                            unsigned char value, void *self) {
...
MyInstance *construct() {
  ...
  my->parser =
      midi_create_parser(0, 0, 0, controlchange_callback, 0, 0, 0, 0, my);
  return my;
}
