...
struct OutputDriver {
   ...
   */
  struct DriverInstance *(*new_instance)(const char *server_name, int xpos,
                                         int ypos, int width, int height,
                                         int mmx_supported, char *error_txt,
                                         int buflen);
   ...
   */
  int (*blit)(struct DriverInstance *self, const unsigned char *fb, int width,
              int height, struct blit_params *params, char *error_text,
              int buflen);
   ...
   */
  int (*frame)(struct DriverInstance *self, int frame_visible, char *error_text,
               int text_len);
   ...
   */
  int (*to_monitor)(struct DriverInstance *self, int monitor, char *error_text,
                    int text_len);
};
