...
void set_adjustment(adjust_pal pal, double bright,
...
__inline void apply_pal(uint_32* dstc, const uint_32* col, const adjust_pal pal)
{
...
void fb_cpy_adjust(uint_32* dst, const uint_32* src, int width, int height,
				   const adjust_pal pal)
{
	uint_32* di = dst;
