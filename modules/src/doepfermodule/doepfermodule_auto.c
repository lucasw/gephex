...
{
  static const char* INFO = "info { name=[Doepferl] group=[Midi] inputs=[3 MIDI_Channel{hidden=[true] higher_bound=[15] widget_type=[number_selector] step_size=[1] lower_bound=[0] help=[Midi Kanal] } Key_Group{hidden=[true] higher_bound=[5] widget_type=[number_selector] step_size=[1] lower_bound=[0] help=[balh] } MidiStrom{help=[balh] } ] outputs=[4 Button_1 Button_2 Button_3 Button_4 ] type=xpm } ";
  char* tmpBuf;
