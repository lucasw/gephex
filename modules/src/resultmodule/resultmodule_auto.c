...
const char* getSpec(void) {
 return "mod_spec { name=[mod_resultmodule] number_of_inputs=[1] number_of_outputs=[0] deterministic=[true] }";
}
...
{
  static const char* INFO = "info { name=[Result] group=[shit] inputs=[1 Eingang ] outputs=[0] type=xpm } ";
  char* tmpBuf;
