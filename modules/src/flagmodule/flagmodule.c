...
void update(void* instance)
{
	...
	framebuffer_getAttributes(inst->out_r, &attribs);
	...
	//glTexSubImage2D (GL_TEXTURE_2D, 0, 3, 256, 256, 0, GL_RGBA, GL_UNSIGNED_BYTE, inst->source->framebuffer);
