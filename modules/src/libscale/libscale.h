 ...
 */
void ls_set_adjustment(ls_adjust_pal pal, double bright, double contrast,
 ...
 */
void ls_scale32m(uint_32 *dst, int dwidth, int dheight, const uint_32 *src,
                 int swidth, int sheight, int mirrorx, int mirrory);

void ls_scale32(uint_32 *dst, int dwidth, int dheight, const uint_32 *src,
