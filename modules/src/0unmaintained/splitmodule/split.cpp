...
void *newInstance(void) {
  ...
  inst->result_r.xsize = 640;
  inst->result_r.ysize = 480;
  inst->result_g.xsize = 640;
  inst->result_g.ysize = 480;
  inst->result_b.xsize = 640;
  inst->result_b.ysize = 480;
...
int getInfo(char *buf, int bufLen) {
  static const char *INFO = "info { name=RGBSplit group=Filter inputs=[1 Bild] "
                            "outputs=[3 Bild Bild Bild] type=xpm }";
  char *tmpBuf;
