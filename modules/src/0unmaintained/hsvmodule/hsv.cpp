...
void RGB_to_HSV(unsigned char r, unsigned char g, unsigned char b, double &h,
                double &s, double &v) {
  /* Given: r, g, b in (byte)
...
void HSV_to_RGB(unsigned char &r, unsigned char &g, unsigned char &b, double h,
                double s, double v) {
  ...
  if (s == 0.0) {
    ...
    case 0:
      ...
      g = (unsigned char)(t * 255.0);
      b = (unsigned char)(p * 255.0);
      break;
    case 1:
      r = (unsigned char)(q * 255.0);
      g = (unsigned char)(v * 255.0);
      b = (unsigned char)(p * 255.0);
      break;
    case 2:
      r = (unsigned char)(p * 255.0);
      g = (unsigned char)(v * 255.0);
      b = (unsigned char)(t * 255.0);
      break;
    case 3:
      r = (unsigned char)(p * 255.0);
      g = (unsigned char)(q * 255.0);
      b = (unsigned char)(v * 255.0);
      break;
    case 4:
      r = (unsigned char)(t * 255.0);
      g = (unsigned char)(p * 255.0);
      b = (unsigned char)(v * 255.0);
      break;
    case 5:
      r = (unsigned char)(v * 255.0);
      g = (unsigned char)(p * 255.0);
      b = (unsigned char)(q * 255.0);
      break;
    }
  }
}
...
const char *getInputSpec(int index) { return INPUT_SPECS[index]; }

const char *getOutputSpec(int index) { return OUTPUT_SPECS[index]; }

const char *getSpec(void) { return SPEC; }

int getInfo(char *buf, int bufLen) {
  static const char *INFO = "info { name=HSV group=Grafikeffekte inputs=[4 "
                            "Zahl Zahl Zahl Bild] outputs=[1 Bild] type=xpm}";
  char *tmpBuf;
