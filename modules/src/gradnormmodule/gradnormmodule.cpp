...
static void sobel(int xsize, int ysize, const uint_32 *fb, uint_32 *outfb,
                  float scale);

static void roberts_cross(int xsize, int ysize, const uint_32 *fb,
                          uint_32 *outfb, float scale);

#if defined(CPU_I386) && defined(OPT_INCLUDE_MMX)

extern "C" {
void roberts_cross_e3dnow(int_32 xsize, int_32 ysize, const uint_32 *fb,
                          uint_32 *outfb, float scale);
}

static void sobel_3dnow(int xsize, int ysize, const uint_32 *fb, uint_32 *outfb,
                        float scale);
...
typedef void (*edge_algo_t)(int, int, const uint_32 *, uint_32 *, float);
