...
public:
   ...
   */
  virtual void open(device_id_t device, int sample_rate, sample_format format,
                    int channels, int samples_per_period, int num_periods) = 0;
   ...
   */
  virtual int write(const unsigned char *data, int num_samples) = 0;
