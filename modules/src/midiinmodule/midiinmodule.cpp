...
MidiInDriver *get_driver(const char *driver_name, int device_id) {
  DriverMap::const_iterator it =
      s_map.find(DriverKey(device_id, std::string(driver_name)));
  if (it != s_map.end()) {
...
void release_driver(MidiInDriver *drv, const char *driver_name, int device_id) {
