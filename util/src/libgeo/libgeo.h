...
void geo_clip_poly_with_line(struct geo_Point *poly, int *num_points,
                             struct geo_Point *point, struct geo_Point *dir,
                             double orientation);
 ...
 */
int geo_intersect_polygons(struct geo_Point *dst, int *n, struct geo_Point *r1,
                           int n1, struct geo_Point *r2, int n2);
...
int geo_intersect_poly_with_line(struct geo_Point *poly, int n,
                                 struct geo_Point *p, struct geo_Point *d,
...
int poly_equals(struct geo_Point *p1, int n1, struct geo_Point *p2, int n2,
                double EPS);
