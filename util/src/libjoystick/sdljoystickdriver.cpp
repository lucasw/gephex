...
public:
  SDLJoystickImpl(SDLJoystickDriverImpl *driver, SDL_Joystick *handle, int id)
  ...
  virtual ~SDLJoystickImpl() { SDL_JoystickClose(m_handle); }

  JoystickDriverImpl *driver() const { return m_driver; }
...
int SDLJoystickDriverImpl::num_joysticks() const { return SDL_NumJoysticks(); }
