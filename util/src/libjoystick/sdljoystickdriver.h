...
#ifndef INCLUDED_SDL_JOYSTICK_DRIVER_H
#define INCLUDED_SDL_JOYSTICK_DRIVER_H

#include "joystickdriver.h"

class SDLJoystickDriverImpl : public JoystickDriverImpl {
public:
  SDLJoystickDriverImpl();
  virtual ~SDLJoystickDriverImpl();
