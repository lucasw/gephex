...
#ifndef INCLUDED_DIRECTIN_JOYSTICK_DRIVER_H
#define INCLUDED_DIRECTIN_JOYSTICK_DRIVER_H

#include "joystickdriver.h"

class DirectInJoystickDriverImpl : public JoystickDriverImpl {
public:
  DirectInJoystickDriverImpl();
  virtual ~DirectInJoystickDriverImpl();
