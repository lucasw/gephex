...
JoystickDriver::~JoystickDriver() { delete m_impl; }

int JoystickDriver::num_devices() const { return m_impl->num_joysticks(); }
...
Joystick::Joystick(JoystickImpl *jst) : m_impl(jst) {
...
Joystick::~Joystick() { delete m_impl; }

int Joystick::num_axes() const { return m_impl->num_axes(); }

int Joystick::num_buttons() const { return m_impl->num_buttons(); }
