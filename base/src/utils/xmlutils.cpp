...
static Iterator scan_string(Iterator begin, Iterator end,
                            const std::string &s) {
  Iterator i = begin;
...
Iterator tagOpens(Iterator begin, Iterator end, const std::string &tag_name) {
  Iterator i = begin;
  i = scan_string(i, end, "<");
...
Iterator tagCloses(Iterator begin, Iterator end, const std::string &tag_name) {
  Iterator i = begin;
  i = scan_string(i, end, "<");
  i = scan_string(i, end, "/");
  i = scan_string(i, end, tag_name);
...
Iterator leafTag(Iterator begin, Iterator end, const std::string &tag_name,
                 std::string &b) {
  Iterator i = begin;
