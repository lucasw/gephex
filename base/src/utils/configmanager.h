...
struct config_param_t {
  ...
  config_param_t(const std::string &name, ParamType type,
                 const std::string &section, const std::string &description,
                 ParamValue *def);
...
public:
  ...
  ConfigManager(const std::string &cfile_name, int argc, const char *argv[],
