...
const std::string &DirEntry::getName() const { return m_name; }

DirEntry::FileType DirEntry::getType() const { return m_type; }

int DirEntry::getSizeInBytes() const { return m_size; }
...
// throw (std::runtime_error)
{
  ...
  while (current != 0) {
    ...
    DirEntry::FileType type =
        S_ISREG(st.st_mode) ? DirEntry::FILE : DirEntry::DIRECTORY;
