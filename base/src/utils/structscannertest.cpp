...
public:
  ...
  virtual void scannedStructName(const std::string &name) { m_name = name; }
...
StructScannerTest::StructScannerTest() : EasyTest("StructScannerTest", "") {}

StructScannerTest::~StructScannerTest() {}

void StructScannerTest::pre() throw(std::runtime_error) {}

static void testDummy(DummyListener &dummy, std::string name, std::string n1,
                      std::string v1, std::string n2, std::string v2) {
...
void StructScannerTest::run() throw(std::runtime_error) {
  ...
  sScanner.scan(
      "info { name=Schrift group=Schrifteffekte inputs=[8 "
      "Text{widget_type=text_edit; hidden=true; default_value=Scrolltext;} "
      "Schriftart{widget_type=font_selector; hidden=true;} "
      "Farbe{widget_type=color_selector; hidden=true;} Position "
      "X-Rotation{widget_type=number_selector; hidden=true; higher_bound=20; "
      "lower_bound=0;}"
      " Y-Rotation{widget_type=number_selector; hidden=true; higher_bound=20; "
      "lower_bound=0;} Z-Rotation{widget_type=number_selector; hidden=true; "
      "higher_bound=20; lower_bound=0;}"
      " Bild] outputs=[1 Bild] type=xpm }");

  testDummy(
      dl, "info", "inputs",
      "8 Text{widget_type=text_edit; hidden=true; default_value=Scrolltext;} "
      "Schriftart{widget_type=font_selector; hidden=true;} "
      "Farbe{widget_type=color_selector; hidden=true;} Position "
      "X-Rotation{widget_type=number_selector; hidden=true; higher_bound=20; "
      "lower_bound=0;}"
      " Y-Rotation{widget_type=number_selector; hidden=true; higher_bound=20; "
      "lower_bound=0;} Z-Rotation{widget_type=number_selector; hidden=true; "
      "higher_bound=20; lower_bound=0;} Bild",
      "group", "Schrifteffekte");

  sScanner.scan(
      "info { name=Schrift group=Schrifteffekte inputs=[4 "
      "Text{widget_type=text_edit; hidden=false; default_value=Scrolltext;} "
      "Schriftart{widget_type=font_selector; hidden=true;} "
      "Geschwindigkeit{widget_type=number_selector; lower_bound=0; "
      "higher_bound=20; hidden=true;} Bild] outputs=[1 Bild] type=xpm }");

  testDummy(
      dl, "info", "inputs",
      "4 Text{widget_type=text_edit; hidden=false; default_value=Scrolltext;} "
      "Schriftart{widget_type=font_selector; hidden=true;} "
      "Geschwindigkeit{widget_type=number_selector; lower_bound=0; "
      "higher_bound=20; hidden=true;} Bild",
      "outputs", "1 Bild");
  ...
  sScanner.scan("Geschwindigkeit{widget_type=number_selector; lower_bound=0; "
                "higher_bound=20; hidden=true;}");
  testDummy(dl, "Geschwindigkeit", "widget_type", "number_selector",
            "lower_bound", "0");
  ...
  testDummy(dl, "info", "inputs",
            "1 Dateiname{widget_type=file_selector; "
            "hidden=true; file_mask=*.bmp; "
            "file_mask_name=Bild; }",
            "outputs", "1 Bild");
