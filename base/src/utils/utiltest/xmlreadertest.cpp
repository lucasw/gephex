...
void XMLReaderTest::run() {
  // create a dummy map with a fakie fucking modulewhateverinfo....actually this
  // infomap fits exactly the file 'testCorrect.graph'...bah, it's 05:19, i'm
  // tired....
  ...
  ModuleInfo *mi =
      new ModuleInfo("mod_stringModule", "String", ins, outs, true);
  ...
  ins2[0] = inpair;
  ModuleInfo *mi2 =
      new ModuleInfo("mod_glOutputModule", "GLoutput", ins, outs, false);
  ...
  ModuleInfo *mi3 =
      new ModuleInfo("mod_tunnelModule", "Tunnel", ins, outs, false);
