...
public:
  MyNetProtocol(net::ICommandInterpreter &ip) : cip(&ip) {}
...
void aDummyReceiver::moduleClassLoaded(const std::string &mcn,
...
std::string ClassInfoTest::getName() const { return "ClassInfoTest"; }

std::string ClassInfoTest::getDescription() const { return ""; }
