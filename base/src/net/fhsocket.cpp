...
FHSocket::FHSocket(void *fh, fh_release_function_t release_function,
                   int localPort)
    : ISocket(localPort), m_fh(fh), m_isConnected(true),
      m_release_function(release_function) {}

FHSocket::~FHSocket() { m_release_function(m_fh); }
...
bool FHSocket::connected() const { return m_isConnected; }
