...
std::string TCPSocketTest::getName() const { return "TCPSocketTest"; }
...
void TCPSocketTest::pre() throw(std::runtime_error) {}
...
void TCPSocketTest::post() throw(std::runtime_error) {}
