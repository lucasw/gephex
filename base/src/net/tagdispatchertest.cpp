...
std::string TagDispatcherTest::getName() const { return "TagDispatcherTest"; }
...
public:
  ...
  void dataReceived(const utils::Buffer &buf) { m_buf = buf; }

  utils::Buffer buffer() const { return m_buf; }
