...
ThreadWINDOWS::ThreadWINDOWS(IRunnable &runner) : IThread(runner) {
...
ThreadWINDOWS::~ThreadWINDOWS() { CloseHandle(hThread); }
...
void MutexWINDOWS::unlock() { ReleaseMutex(hMutex); }
