...
ThreadPOSIX::ThreadPOSIX(IRunnable &runner) : IThread(runner) {
  pthread_t t;
...
void MutexPOSIX::lock() { pthread_mutex_lock((pthread_mutex_t *)m_mutex); }

void MutexPOSIX::unlock() { pthread_mutex_unlock((pthread_mutex_t *)m_mutex); }
